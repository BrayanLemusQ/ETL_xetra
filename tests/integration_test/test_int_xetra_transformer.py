...
from xetra_project.common.s3 import S3BucketConnector
from xetra_project.common.constants import MetaProcessFormat
from xetra_project.transformers.xetra_transformer import XetraETL, XetraSourceConfig, XetraTargetConfig
...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-blq-int-test-src'
        self.s3_bucket_name_trg = 'xetra-blq-int-test-trg'
